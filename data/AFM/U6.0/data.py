...
plt.plot(Sig_ori[:,0],Sig_ori[:,5],'-o', label  = "0_pi")
plt.plot(Sig_ori[:,0],Sig_ori[:,9],'-o', label  = "pi_pi")
plt.legend()
plt.xlim(0,10)
...
plt.plot(Sig_ori[:,0],Sig_ori[:,6],'-o', label  = "0_pi")
plt.plot(Sig_ori[:,0],Sig_ori[:,10],'-o', label  = "pi_pi")
plt.legend()
plt.xlim(0,10)
